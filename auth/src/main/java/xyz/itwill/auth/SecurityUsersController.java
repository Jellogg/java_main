...
public class SecurityUsersController {
	...
	public String addUsers() {
		SecurityUsers user1=new SecurityUsers("abc123", 
				passwordEncoder.encode("123456"), "È«±æµ¿", "abc@itwill.xyz", "1", null);
		SecurityUsers user2=new SecurityUsers("xyz789", 
				passwordEncoder.encode("123456"), "ÀÓ²©Á¤", "xyz@itwill.xyz", "1", null);
		SecurityUsers user3=new SecurityUsers("opq456", 
				passwordEncoder.encode("123456"), "Àü¿ìÄ¡", "opq@itwill.xyz", "1", null);
